...
class RepositoryPolicyTest(unittest.TestCase):
    ...
    def test_public_disclosure_policy_defines_eligibility_and_exclusions(
        ...
        required_markers = (
            ...
            "safe to disclose",
            "durable value",
            "code, documentation, data, CI configuration, and release artifacts",
    ...
    def test_agents_require_local_codex_public_disclosure_review(self) -> None:
        ...
        required_markers = (
            ...
            "Before Codex prepares or executes a commit, push, or release",
            "staged diff",
    ...
    def test_ci_keeps_disclosure_review_local(self) -> None:
    ...
    def test_sensitive_and_materialized_paths_are_ignored(self) -> None:
        ...
        expected_dockerignore = [
            ...
            "!src/ossp_router/routing_artifacts.py",
            "!src/ossp_router/routing_costs.py",
            "!src/ossp_router/routing_features.py",
            "!src/ossp_router/routing_quality.py",
